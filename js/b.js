...
},{"./views/game/main":6,"./views/setup/main":8,"./views/stats/main":10,"backbone":22}],4:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../engine/Class":14}],6:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./tpl/game.hbs":7,"backbone":22}],7:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "\n<h2>Find which interval is played...</h2>\n<div class=\"row\">\n	<div class=\"col-md-4 col-xs-12 controls\">\n		<span class=\"score\">Score: 0/0</span>\n	</div>\n	<div class=\"col-md-4 col-xs-12 controls\">\n		<span class=\"btn btn-primary btn-lg col-xs-12 play\">play interval</span>\n	</div>\n	<div class=\"col-md-4 col-xs-12 controls\">\n		<span class=\"btn btn-danger btn-lg col-xs-12 reset\">new set up</span>\n	</div>\n</div>\n\n\n<div class=\"row\">\n	<div id=\"intervals-minor-second\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Minor second</span>\n	</div>\n\n	<div id=\"intervals-second\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Second</span>\n	</div>\n\n	<div id=\"intervals-minor-third\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Minor third</span>\n	</div>\n\n	<div id=\"intervals-third\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Third</span>\n	</div>\n	\n	<div id=\"intervals-fourth\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Fourth</span>\n	</div>\n\n	<div id=\"intervals-triton\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Triton</span>\n	</div>\n	\n	<div id=\"intervals-fifth\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Fifth</span>\n	</div>\n	<div id=\"intervals-minor-sixth\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Minor six</span>\n	</div>\n	<div id=\"intervals-sixth\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Sixth</span>\n	</div> \n	\n	<div id=\"intervals-minor-seventh\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Minor seventh</span>\n	</div>\n\n	<div id=\"intervals-seventh\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Seventh</span>\n	</div>\n\n	<div id=\"intervals-octave\" class=\"intervals col-md-3 col-xs-6\">\n		<span class=\"btn btn-default col-xs-12\">Octave</span>\n	</div>\n</div>	\n\n";
},"useData":true});
...
},{"./tpl/setup.hbs":9,"backbone":22}],9:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<form>\n	<h2>Set up the training</h2>\n	<div class=\"row\">\n		<div class=\"col-md-6 col-xs-12\">\n			<label>Choose the intervals to train on:</label>\n		</div>\n		<div class=\"col-md-6 col-xs-12\">\n			<select id=\"itv-select\" class=\"selectpicker form-control\">\n				<option value=\"beginner\">third  - fifth - octave</option>\n				<option value=\"easy\">fourth - sixth - seventh</option>\n				<option value=\"intermediate\">second - triton - seventh</option>\n				<option value=\"expert\">All intervals</option>\n			</select>\n		</div>\n	</div>\n	<div class=\"row\">\n		<div class=\"col-md-6 col-xs-12\">\n			<label>Octave range:</label>\n		</div>\n		<div class=\"col-md-6 col-xs-12\">\n			<select id=\"rng-select\" class=\"selectpicker form-control\">\n				<option value=\"1\">1 octave</option>\n				<option value=\"2\">2 octaves</option>\n				<option value=\"3\">3 octaves</option>\n			</select>\n		</div>\n	</div>\n	<div class=\"row\">\n		<div class=\"col-md-6 col-xs-12\">\n			<label>Choose the way the interval is played:</label>\n		</div>\n		<div class=\"col-md-6 col-xs-12\">\n			<input type=\"radio\" name=\"play-way\" value=\"u\" checked=\"checked\" />  <label> upward </label><br />\n			<input type=\"radio\" name=\"play-way\" value=\"d\" /> <label> downward </label>\n		</div>\n	</div>\n	<div class=\"row\">\n		<div class=\"col-md-6 col-md-offset-6 col-xs-offset-0\">\n			<button type=\"submit\" class=\"btn btn-primary btn-lg col-xs-12\">Start session</button>\n		</div>\n		\n	</div>\n</form>";
},"useData":true});
...
},{"../../stats":5,"./tpl/line.hbs":11,"backbone":22}],11:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data,blockParams,depths) {
    var stack1, helper, options, buffer = 
  "	\n	<div class=\"col-xs-12\">\n		<ul>\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.correct : depth0),{"name":"if","hash":{},"fn":this.program(2, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "			<li class=\"log-label\">\n				<div class=\"row\">\n					<div class=\"col-xs-12\"><strong class=\"text-primary\">You confused <em>"
    + this.escapeExpression(this.lambda((depths[1] != null ? depths[1].interval : depths[1]), depth0))
    + "</em> with:</strong></div>\n				</div>\n			</li>\n			\n";
  stack1 = ((helper = (helper = helpers.errors || (depth0 != null ? depth0.errors : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"errors","hash":{},"fn":this.program(4, data, 0, blockParams, depths),"inverse":this.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0,options) : helper));
  ...
  return "			<li>\n				<div class=\"row "
    + alias1(((helper = (helper = helpers.intervalId || (depth0 != null ? depth0.intervalId : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"intervalId","hash":{},"data":data}) : helper)))
    + "\">\n					<div class=\"col-xs-6\">correct answer "
    + alias1(alias2((depths[1] != null ? depths[1].correct : depths[1]), depth0))
    + " time(s)</div>\n					<div class=\"col-xs-6\">\n						<div style=\"width:"
    + alias1(alias2((depths[1] != null ? depths[1].oldAverage : depths[1]), depth0))
    + "%;\" class=\"bg-primary log-graph\"></div>\n					</div>\n				</div>\n			</li>\n";
},"4":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "			\n			<li>\n				<div class=\"row "
    + alias3(((helper = (helper = helpers.intervalId || (depth0 != null ? depth0.intervalId : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"intervalId","hash":{},"data":data}) : helper)))
    + "\">\n					<div class=\"col-xs-6 log-error\">- <em>"
    ...
    + " time(s)</div>\n					<div class=\"col-xs-6\">\n						<div style=\"width:"
    + alias3(((helper = (helper = helpers.oldAverage || (depth0 != null ? depth0.oldAverage : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"oldAverage","hash":{},"data":data}) : helper)))
    + "%;\" class=\"bg-wrong log-graph\"></div>\n					</div>\n				</div>\n			</li>\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data,blockParams,depths) {
    var stack1, helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "<div id=\"log-line-"
    + alias3(((helper = (helper = helpers.intervalId || (depth0 != null ? depth0.intervalId : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"intervalId","hash":{},"data":data}) : helper)))
    + "\" class=\"log-container xbounceInLeft xanimated\">\n<div class=\"row\">\n	<div class=\"col-xs-12\">\n		<h4>\n			<span>\n				You recognized the "
    + alias3(((helper = (helper = helpers.interval || (depth0 != null ? depth0.interval : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"interval","hash":{},"data":data}) : helper)))
    + " <strong>"
    + alias3(((helper = (helper = helpers.average || (depth0 != null ? depth0.average : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"average","hash":{},"data":data}) : helper)))
    + "%</strong> of the time ("
    ...
    + "/"
    + alias3(((helper = (helper = helpers.tries || (depth0 != null ? depth0.tries : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"tries","hash":{},"data":data}) : helper)))
    + ")\n			</span>\n		</h4>\n	</div>\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.errors : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "</div>\n</div>";
...
},{"./app/config":2,"./engine/Class":14,"./engine/Instrument/Piano":16,"./engine/Music/Intervals":17,"./engine/Music/Notes":18,"./engine/Sequencer/Scheduler":19}],13:[function(require,module,exports){
var types = {
    'mp3': 'audio/mpeg',
    'ogg': 'audio/ogg',
    'wav': 'audio/wav',
...
},{"../Audio/Sound":13,"../Class":14,"backbone":22}],16:[function(require,module,exports){
...
},{"./Intervals":17}],19:[function(require,module,exports){
...
},{"../Class":14,"./Timeline":20}],20:[function(require,module,exports){
...
},{"../Class":14}],21:[function(require,module,exports){
...
},{"jquery":33,"underscore":23}],23:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"./handlebars/base":25,"./handlebars/exception":26,"./handlebars/no-conflict":27,"./handlebars/runtime":28,"./handlebars/safe-string":29,"./handlebars/utils":30}],25:[function(require,module,exports){
'use strict';
...
/* [args, ]options */
},{"./exception":26,"./utils":30}],26:[function(require,module,exports){
'use strict';
...
},{"./base":25,"./exception":26,"./utils":30}],29:[function(require,module,exports){
'use strict';
...
},{"./dist/cjs/handlebars.runtime":24}],32:[function(require,module,exports){
